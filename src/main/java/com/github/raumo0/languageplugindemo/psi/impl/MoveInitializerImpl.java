...
public class MoveInitializerImpl extends ASTWrapperPsiElement implements MoveInitializer {

  public MoveInitializerImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public MoveExpr getExpr() {
    return findNotNullChildByClass(MoveExpr.class);
  }
