...
public class MoveTypeImpl extends ASTWrapperPsiElement implements MoveType {

  public MoveTypeImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public MoveTupleType getTupleType() {
    return findChildByClass(MoveTupleType.class);
  }
